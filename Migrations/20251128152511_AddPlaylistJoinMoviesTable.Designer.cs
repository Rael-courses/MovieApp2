...
namespace MovieAppApi.Migrations
{
    ...
    [Migration("20251128152511_AddPlaylistJoinMoviesTable")]
    partial class AddPlaylistJoinMoviesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MovieAppApi.Src.Core.Repositories.Entities.PlaylistJoinMovieEntity", b =>
                {
                    ...
                    b.HasOne("MovieAppApi.Src.Core.Repositories.Entities.PlaylistEntity", "PlaylistEntity")
                        .WithMany("PlaylistJoinMovies")
